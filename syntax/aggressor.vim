...
" Arrays
syntax match array "\v\@"                               " Example: @(xxx, xxx, xxx,)
highlight link array Type

" Hashes
syntax match hash "\v\%"                                " Example: %(key => 'val', key => 'val')
highlight link hash Type

" Comments
syntax match comment "\v#.*$"                           " Example: # This is a comment
highlight link comment Comment

" Regular variables
" Example: $variable
syntax match namedVariables "\v\$[[:alpha:]][[:alnum:]_]+" containedin=doubleString,singleString
...
syntax keyword Keywords if else while for return foreach
...
" Escape characters
syntax match escapecharacters "\v\\U" containedin=doubleString,singleString
syntax match escapecharacters "\v\\u" containedin=doubleString,singleString
syntax match escapecharacters "\v\\c." containedin=doubleString,singleString
syntax match escapecharacters "\v\\n" containedin=doubleString,singleString
syntax match escapecharacters "\v\\o" containedin=doubleString,singleString
syntax match escapecharacters "\v\\t" containedin=doubleString,singleString
syntax match escapecharacters "\v\\r" containedin=doubleString,singleString
syntax match escapecharacters "\v\\x" containedin=doubleString,singleString
syntax match escapecharacters "\v\\\\" containedin=doubleString,singleString
highlight link escapecharacters Special

" Mnemonics
syntax match mnemonics "\v\&." containedin=doubleString,singleString
